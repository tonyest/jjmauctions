			...
			<div class="post clearfix">				
				...
				<div class="product-info">
					...
					<div id="bid-history">
						...
						$bids = get_posts( $args );?>
							<h3><?php _e( 'Bid History', 'eStore' )?></h3>
						...
						<?php if (get_option('estore_postinfo2') <> '' && !$et_page) { ?>
							...
							<p class="post-meta"><?php _e('Added','eStore'); ?><?php if (in_array('date', get_option('estore_postinfo2'))) { ?> <?php _e('on','eStore') ?> <?php the_time(get_option('estore_date_format')) ?><?php }; ?> <?php if ( function_exists('pp_get_the_term_list' ) && is_using_custom_taxonomies() ) { ?> <?php pp_get_the_term_list(); ?><?php }; ?></p>
						<?php }; ?>
					<div class="clearfix">
